...
button.setOnClickListener(new View.OnClickListener() {
    ...
    public void addItem(View view) {
        ...
        else if(name.getText().toString().isEmpty()||price.getText().toString().isEmpty()||quantity.getText().toString().isEmpty())
            Toast.makeText(this,"Fill All Record",Toast.LENGTH_SHORT).show();
        else if(Integer.parseInt(price.getText().toString())<1 || Integer.parseInt(quantity.getText().toString())<1)
            Toast.makeText(this,"Price & Quantity should be greater then 1",Toast.LENGTH_SHORT).show();
        else
        {
            loading.show();
